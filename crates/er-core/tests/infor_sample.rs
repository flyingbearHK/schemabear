use er_core::{
    auto_layout, export_dbml, export_mermaid, import_dbml, import_mermaid, validate,
};
use std::fs;
use std::path::PathBuf;

fn fixture_path() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../fixtures/infor_hms_sample.mmd")
}

#[test]
fn infor_sample_mermaid_import_validate_layout_export() {
